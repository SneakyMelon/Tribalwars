 ...
 * 
 * @author  Sneaky Melon
 * @description Fake and Farm Script by Sneaky Melon
 * @contact[IGN] SneakyMelon
 * 
 */

/*
 * War buddies - List of villages with a single space separating each village, using a single line.
 *
 * Each village must use the Pipe (|) symbol to separate the X and Y coordinates.
 */
 
var coords = "651|479 654|481 608|421 601|412 650|481 624|439 635|467 646|467 634|431 625|450 625|417 621|451 554|354 628|470 642|473	618|447	556|361	611|469	557|366	646|466	619|448	644|467	619|428	642|475	620|435	639|470	631|459	634|443	632|449	626|444	627|448	640|488	621|431	619|441	625|454	635|483	629|470	648|489	640|486	631|476	625|428	624|432	626|460	643|470	622|471	621|433	642|485	620|438	642|471	637|476	624|460	628|489	623|432	635|477	620|434	634|466	613|451";
...
if (document.URL.indexOf("screen=place") === -1) {
	alert("This has to be run from the rally point.");
} else {
	init();
}
